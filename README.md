...
This package is supported on Umbraco 7.15.0+ and Umbraco Forms 7.4.0+.

### Installation

ActiveIS.UmbracoForms.CustomEmail-v7 is available from [NuGet](https://www.nuget.org/packages/ActiveIS.UmbracoForms.CustomEmail) or as a manual download directly from GitHub.
...
This is tested with **Umbraco V7.15.6** and **Umbraco Forms 7.4.1**
